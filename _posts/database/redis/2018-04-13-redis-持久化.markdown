...
save m n的原理如下：每隔100ms，执行serverCron函数；在serverCron函数中，遍历save m n配置的保存条件，只要有一个条件满足，就进行bgsave。对于每一个save m n条件
...
参考 [https://www.cnblogs.com/kismetv/p/9137897.html](https://www.cnblogs.com/kismetv/p/9137897.html)